# 5. trust / public institution / oecd / driver

`T0005` · 197 documents · 2018–2026
...
| Emergence (Rotolo) | 0.698 | Weighted five-attribute score |
| — novelty | 0.731 | Distance from where the field already was |
| — growth | 0.000 | CAGR blended with burst intensity |
| — coherence | 0.332 | How tightly the documents cluster |
...
| Asset leverage | 0.060 | What IP Australia would bring |
...
- **Growth:** -2.4% per year · maturity 0.59
- **Burst periods:** none detected

## Defining terms

`trust`, `public institution`, `institution`, `trust public`, `public`, `driver trust`, `public trust`, `oecd`, `driver`, `covid-19`
