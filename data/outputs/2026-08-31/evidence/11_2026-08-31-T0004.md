# 11. trust / institution / public / driver

`2026-08-31-T0004` · 134 documents · 2018–2026
...
| — novelty | 0.777 | Distance from where the field already was |
| — growth | 0.069 | CAGR blended with burst intensity |
| — coherence | 0.381 | How tightly the documents cluster |
| — impact | 0.704 | Citation percentile within source |
| — uncertainty | 0.804 | Dispersion of actors and evidence types |
| Strategic fit | 0.190 | Closeness to published strategy |
...
- **Growth:** -2.0% per year · maturity 0.71
- **Burst periods:** 2018

## Defining terms

`trust`, `institution`, `public institution`, `trust public`, `public`, `public trust`, `driver trust`, `trust institution`, `citizen trust`, `driver`
