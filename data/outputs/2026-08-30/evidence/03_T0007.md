# 3. automated decision-making / administrative / law / system

`T0007` · 45 documents · 2018–2026
...
|---|---:|---|
| Composite rank score | 0.643 | Weighted emergence + fit + leverage |
| Emergence (Rotolo) | 0.664 | Weighted five-attribute score |
| — novelty | 0.766 | Distance from where the field already was |
| — growth | 0.148 | CAGR blended with burst intensity |
| — coherence | 0.475 | How tightly the documents cluster |
| — impact | 0.793 | Citation percentile within source |
| — uncertainty | 0.631 | Dispersion of actors and evidence types |
| Strategic fit | 0.107 | Closeness to published strategy |
| Asset leverage | 0.054 | What IP Australia would bring |
| Opportunity index | 0.391 | **Relative only — not a market size** |
...
- **Growth:** +6.6% per year · maturity 0.91
- **Burst periods:** 2023

## Defining terms

`automated decision-making`, `automated`, `decision-making`, `administrative`, `administrative law`, `law`, `system`, `ai`, `decision-making public`, `decision-making system`
