...
| Strategic fit | 0.067 | Closeness to published strategy |
| Asset leverage | 0.069 | What IP Australia would bring |
| Opportunity index | 0.618 | **Relative only — not a market size** |
...
`arc additive`, `wire arc`, `additive`, `additive manufacturing`, `wire`, `intelligence wire`, `manufacturing systematic`, `manufacturing`, `arc`, `systematic patent`
