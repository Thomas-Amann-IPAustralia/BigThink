...
`2026-09-14T1434-T0027` · 204 documents · 2018–2026
...
|---|---:|---|
| Composite rank score | 0.917 | Weighted emergence + fit + leverage |
...
| — coherence | 0.740 | How tightly the documents cluster |
| — impact | 0.573 | Citation percentile within source |
| — uncertainty | 0.802 | Dispersion of actors and evidence types |
| Strategic fit | 0.667 | Closeness to published strategy |
| Asset leverage | 0.455 | What IP Australia would bring |
| Opportunity index | 0.734 | **Relative only — not a market size** |
...
- **Growth:** +6.3% per year · maturity 0.91
- **Burst periods:** 2023

## Defining terms

`automated decision-making`, `decision-making`, `automated`, `administrative`, `administrative decision-making`, `administrative law`, `automated decision`, `government`, `governmental automated`, `decision`
