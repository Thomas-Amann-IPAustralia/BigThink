# 3. trust / institution / public / citizen

`T0002` · 130 documents · 2018–2026
...
|---|---:|---|
| Composite rank score | 0.638 | Weighted emergence + fit + leverage |
| Emergence (Rotolo) | 0.523 | Weighted five-attribute score |
| — novelty | 0.702 | Distance from where the field already was |
| — growth | 0.074 | CAGR blended with burst intensity |
| — coherence | 0.428 | How tightly the documents cluster |
| — impact | 0.759 | Citation percentile within source |
| — uncertainty | 0.444 | Dispersion of actors and evidence types |
| Strategic fit | 0.184 | Closeness to published strategy |
| Asset leverage | 0.042 | What IP Australia would bring |
| Opportunity index | 0.679 | **Relative only — not a market size** |
...
- **Growth:** +2.1% per year · maturity 0.59
- **Burst periods:** 2018

## Defining terms

`trust`, `institution`, `public`, `public institution`, `trust public`, `public trust`, `citizen`, `trust government`, `citizen trust`, `government`
