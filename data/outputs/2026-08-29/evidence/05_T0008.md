# 5. automated decision-making / administrative law / decision-making system / decision-making public

`T0008` · 37 documents · 2018–2026
...
|---|---:|---|
| Composite rank score | 0.625 | Weighted emergence + fit + leverage |
| Emergence (Rotolo) | 0.657 | Weighted five-attribute score |
| — novelty | 0.789 | Distance from where the field already was |
| — growth | 0.180 | CAGR blended with burst intensity |
| — coherence | 0.489 | How tightly the documents cluster |
| — impact | 0.818 | Citation percentile within source |
| — uncertainty | 0.000 | Dispersion of actors and evidence types |
| Strategic fit | 0.097 | Closeness to published strategy |
...
- **Growth:** +10.7% per year · maturity 0.83
- **Burst periods:** 2023

## Defining terms

`automated decision-making`, `automated`, `decision-making`, `administrative law`, `decision-making system`, `decision-making public`, `law`, `administrative`, `accountability`, `accountability automated`
